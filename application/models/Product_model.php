...
//		}
	...
	//get paginated tag products
	public function get_paginated_tag_products($category_id, $subcategory_id, $third_category_id,$per_page, $offset, $tag_slug)
	{
		$this->filter_products($category_id, $subcategory_id, $third_category_id);
		$this->db->join('product_tags', 'products.id= product_tags.product_id');
	...
	//get paginated tag products count
	public function get_paginated_tag_products_count($tag_slug)
	{
