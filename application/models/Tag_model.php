...
class Tag_model extends CI_Model
{
    ...
    */
    ...
    // add product tag
	public function add_product_tags($product_id)
	{
		$post_id = clean_number($product_id);
		//tags
		$tags = trim($this->input->post('tags', true));
...
//update product tags
	...
	{
		$products_id = clean_number($product_id);
		//delete old tags
		$this->delete_product_tags($products_id);
	...
	//get random product tags
	public function get_random_product_tags()
	{
		$this->db->join('products', 'products.id = product_tags.product_id');
		$this->db->select('product_tags.tag_slug, product_tags.tag');
		$this->db->group_by('tag_slug, product_tags.tag');
...
//get product tag
	public function get_product_tag($tag_slug)
	{
//		$tag_slug = clean_slug($tag_slug);
		$this->db->join('products', 'products.id = product_tags.product_id');
		$this->db->select('product_tags.*');
		$this->db->where('product_tags.tag_slug', $tag_slug);
		$query = $this->db->get('product_tags');
		return $query->row();
	}
	//get products tags
