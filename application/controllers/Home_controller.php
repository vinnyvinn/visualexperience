	...
	public function product($slug)
	{
	    ...
	    if (empty($data['product'])) {
			...
			$product_id = $data["product"]->id;
             $data['digital_file'] = $this->db->query("SELECT * FROM digital_files WHERE product_id=$product_id")->row();
			...
			$data['product_tags'] = $this->tag_model->get_product_tags($data["product"]->id);
			...
			$data['random_tags'] = $this->tag_model->get_random_product_tags();
			$this->load->view('partials/_header', $data);
